...
enum {
  ...
  l_osd_client_op_r_lat,
  l_osd_client_op_r_q_lat,
  l_osd_client_op_r_process_lat,
  l_osd_client_op_r_blocked_lat,
  l_osd_op_w,
  l_osd_op_w_inb,
  l_osd_op_w_rlat,
  l_osd_op_w_lat,
  ...
  l_osd_client_op_w_lat,
  l_osd_client_op_w_q_lat,
  l_osd_client_op_w_process_lat,
  l_osd_client_op_w_blocked_lat,
  l_osd_op_rw,
  l_osd_op_rw_inb,
  l_osd_op_rw_outb,
  l_osd_op_rw_rlat,
  ...
  l_osd_tier_promote,
  l_osd_tier_r_promote,
  l_osd_tier_w_promote,
  l_osd_tier_flush,
  ...
  l_osd_op_tier_r_total,
  l_osd_op_tier_w_total,
  l_osd_op_tier_total,
  l_osd_op_tier_hit,
  l_osd_op_tier_r_hit,
  l_osd_op_tier_w_hit,
