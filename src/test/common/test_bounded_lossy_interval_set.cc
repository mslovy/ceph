...
class BoundedLossyIntervalSetTest : public ::testing::Test {

 public:
  typedef T ISet;
};

typedef ::testing::Types< bounded_lossy_interval_set<IntervalValueType> > IntervalSetTypes;

TYPED_TEST_CASE(BoundedLossyIntervalSetTest, IntervalSetTypes);

TYPED_TEST(BoundedLossyIntervalSetTest, compare) {
  typedef typename TestFixture::ISet ISet;
  ISet iset1(3), iset2(3);
...
TYPED_TEST(BoundedLossyIntervalSetTest, contains) {
  typedef typename TestFixture::ISet ISet;
  ISet iset1(3);
  ...
  iset1.insert(50, 10);
  iset1.insert(60, 5);
  ASSERT_FALSE(iset1.contains( 1, 4 ));
  ASSERT_FALSE(iset1.contains( 1, 5 ));
  ASSERT_FALSE(iset1.contains( 2, 2 ));
  ASSERT_FALSE(iset1.contains( 2, 4 ));
  ...
  ASSERT_TRUE(iset1.contains( 31 ));
  ASSERT_TRUE(iset1.contains( 32, 5 ));
  ASSERT_FALSE(iset1.contains( 38, 5 ));
  ASSERT_TRUE(iset1.contains( 55 ));
  ASSERT_TRUE(iset1.contains( 54, 4 ));
  ASSERT_FALSE(iset1.contains( 47, 10 ));
  ASSERT_FALSE(iset1.contains( 11, 11 ));
  ASSERT_FALSE(iset1.contains( 18, 9 ));

  iset1.insert(70, 10);
  ASSERT_FALSE(iset1.contains( 10, 10 ));
  ...
  ASSERT_FALSE(iset1.contains( 30, 3 ));
  ASSERT_FALSE(iset1.contains( 50, 4 ));
}

TYPED_TEST(BoundedLossyIntervalSetTest, intersects) {
  typedef typename TestFixture::ISet ISet;
  ISet iset1(3);
  ...
  iset1.insert(50, 10);
  iset1.insert(60, 5);
  ASSERT_FALSE(iset1.intersects( 1, 4 ));
  ASSERT_FALSE(iset1.intersects( 1, 5 ));
  ASSERT_TRUE(iset1.intersects( 1, 10 ));
  ASSERT_FALSE(iset1.intersects( 2, 2 ));
  ASSERT_FALSE(iset1.intersects( 2, 4 ));
  ...
  ASSERT_TRUE(iset1.intersects( 21, 12 ));
  ASSERT_TRUE(iset1.intersects( 37, 2 ));
  ASSERT_TRUE(iset1.intersects( 37, 9 ));
  ASSERT_FALSE(iset1.intersects( 40, 1 ));
  ASSERT_FALSE(iset1.intersects( 42, 8 ));
  ASSERT_TRUE(iset1.intersects( 55, 2 ));
  ASSERT_TRUE(iset1.intersects( 62, 9 ));
  ASSERT_FALSE(iset1.intersects( 65, 1 ));
  ASSERT_FALSE(iset1.intersects( 69, 4 ));
...
TYPED_TEST(BoundedLossyIntervalSetTest, insert_erase) {
  typedef typename TestFixture::ISet ISet;
  ISet iset1(3), iset2(3);
  ...
  //adding rigtmost erase interval 0~8 automatically 
  iset1.insert(36, 9, &start, &len);
  ASSERT_TRUE( start == 36 );
  ASSERT_TRUE( len == 9 );
  ASSERT_TRUE( iset1.num_intervals() == 3);
  ASSERT_EQ( iset1.size(), 27);
  ...
  ASSERT_FALSE( iset1.contains( 34, 1 ));
  ASSERT_FALSE( iset1.contains( 35, 10 ));
  ASSERT_TRUE(iset1.contains( 40, 5 ));
  ASSERT_TRUE(iset1.contains( 15, 10 ));
  ASSERT_TRUE(iset1.contains( 0, 8 ));
  ...
  ASSERT_TRUE( iset1.contains( 1, 1 ));
  ASSERT_FALSE( iset1.contains( 2, 1 ));
  ASSERT_FALSE( iset1.contains( 3, 1 ));
  ASSERT_FALSE( iset1.contains( 4, 1 ));
  ASSERT_TRUE( iset1.contains( 5, 1 ));
  ASSERT_TRUE( iset1.contains( 15, 1 ));

  iset1.erase(0, 2);
  ASSERT_TRUE( iset1.num_intervals() == 2 );
  ASSERT_EQ( iset1.size(), 13 );
  ASSERT_FALSE( iset1.contains( 1, 1 ));
  ASSERT_TRUE( iset1.contains( 15, 10 ));
  ASSERT_TRUE( iset1.contains( 5, 3 ));

  iset1.erase(15, 10);
  ASSERT_TRUE( iset1.num_intervals() == 1 );
  ASSERT_TRUE( iset1.size() == 3 );
  ASSERT_FALSE( iset1.contains( 1, 1 ));
  ...
  iset1.erase( 5, 1);
  ASSERT_TRUE( iset1.num_intervals() == 1 );
  ASSERT_TRUE( iset1.size() == 2 );
  ASSERT_FALSE( iset1.contains( 1, 1 ));
  ASSERT_FALSE( iset1.contains( 15, 10 ));
  ASSERT_FALSE( iset1.contains( 25, 1 ));
  ASSERT_TRUE( iset1.contains( 6, 2 ));
...
TYPED_TEST(BoundedLossyIntervalSetTest, intersect_of) {
  typedef typename TestFixture::ISet ISet;
  ISet iset1(1), iset2(2), iset3(3);
  ...
  ASSERT_FALSE( iset1.contains( 30, 2 ));
  ASSERT_FALSE( iset1.contains( 35, 4 ));

  ASSERT_FALSE( iset1.contains( 39, 1 ));
...
TYPED_TEST(BoundedLossyIntervalSetTest, union_of) {
  typedef typename TestFixture::ISet ISet;
  ISet iset1(1), iset2(2), iset3(3);
  ...
  ASSERT_TRUE( iset1.num_intervals() == 1);
  ASSERT_EQ( iset1.size(), 13); //actually we added nothing
  ASSERT_TRUE( iset1.contains( 29, 13 ));
  ASSERT_FALSE( iset1.contains( 29, 14 ));
  ASSERT_FALSE( iset1.contains( 42, 1 ));
...
TYPED_TEST(BoundedLossyIntervalSetTest, subset_of) {
  typedef typename TestFixture::ISet ISet;
  ISet iset1(1), iset2(2);
...
TYPED_TEST(BoundedLossyIntervalSetTest, span_of) {
  typedef typename TestFixture::ISet ISet;
  ISet iset1(1), iset2(2);
  ...
  ASSERT_EQ( iset1.size(), 3);
  ASSERT_FALSE( iset1.contains( 8, 2 ));
  ...
  ASSERT_EQ( iset1.num_intervals(), 1);
  ASSERT_EQ( iset1.size(), 5);
  ASSERT_FALSE( iset1.contains( 5, 5 ));
  ASSERT_TRUE( iset1.contains( 20, 5 ));
