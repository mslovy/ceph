...
#ifdef MAX_NUM_INTERVALS
#undef MAX_NUM_INTERVALS
...
TYPED_TEST(IntervalSetTest, contains) {
  ...
  ASSERT_TRUE(iset.contains( 31 ));
  ASSERT_FALSE(iset.contains( 38, 5 ));
  ASSERT_TRUE(iset.contains( 55 ));
  ASSERT_FALSE(iset.contains( 47, 10 ));
